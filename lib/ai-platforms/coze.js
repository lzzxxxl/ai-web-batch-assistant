...
export class CozeAdapter extends BasePlatformAdapter {
  constructor() { super(); this.name = 'coze'; }
  ...
  isGenerating() { return document.querySelector('.streaming') !== null || document.querySelector('.typing') !== null; }
}
